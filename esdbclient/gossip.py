...
#
#
# class BaseClusterGossipService(ESDBService[TGrpcStreamers]):
#     def __init__(
#         self,
#         channel: Union[grpc.Channel, grpc.aio.Channel],
#         connection_spec: ConnectionSpec,
...
#
#
# class AsyncioClusterGossipService(BaseClusterGossipService[AsyncGrpcStreamers]):
#     pass
#
#
# class ClusterGossipService(BaseClusterGossipService[SyncGrpcStreamers]):
#     """
