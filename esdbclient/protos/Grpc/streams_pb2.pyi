    ...
    class Options(google.protobuf.message.Message):
        ...
        class StreamOptions(google.protobuf.message.Message):
            ...
            def __init__(
                ...
                *,
                stream_identifier: (
                    esdbclient.protos.Grpc.shared_pb2.StreamIdentifier | None
                ) = ...,
                revision: builtins.int = ...,
            ...
            def WhichOneof(
                self, oneof_group: typing.Literal["revision_option", b"revision_option"]
            ) -> typing.Literal["revision", "start", "end"] | None: ...
        ...
        class AllOptions(google.protobuf.message.Message):
            ...
            def WhichOneof(
                self, oneof_group: typing.Literal["all_option", b"all_option"]
            ) -> typing.Literal["position", "start", "end"] | None: ...
        ...
        class FilterOptions(google.protobuf.message.Message):
            ...
            class Expression(google.protobuf.message.Message):
                ...
                def ClearField(
                    self,
                    field_name: typing.Literal["prefix", b"prefix", "regex", b"regex"],
                ) -> None: ...
            ...
            def __init__(
                ...
                *,
                stream_identifier: (
                    global___ReadReq.Options.FilterOptions.Expression | None
                ) = ...,
                event_type: (
                    global___ReadReq.Options.FilterOptions.Expression | None
                ) = ...,
            ...
            @typing.overload
            def WhichOneof(
                self, oneof_group: typing.Literal["filter", b"filter"]
            ) -> typing.Literal["stream_identifier", "event_type"] | None: ...
            @typing.overload
            def WhichOneof(
                self, oneof_group: typing.Literal["window", b"window"]
            ) -> typing.Literal["max", "count"] | None: ...
        ...
        class UUIDOption(google.protobuf.message.Message):
            ...
            ) -> typing.Literal["structured", "string"] | None: ...
        ...
        class ControlOption(google.protobuf.message.Message):
            ...
            def ClearField(
                self, field_name: typing.Literal["compatibility", b"compatibility"]
            ) -> None: ...
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["count_option", b"count_option"]
        ) -> typing.Literal["count", "subscription"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["filter_option", b"filter_option"]
        ) -> typing.Literal["filter", "no_filter"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["stream_option", b"stream_option"]
        ) -> typing.Literal["stream", "all"] | None: ...
...
class ReadResp(google.protobuf.message.Message):
    ...
    class ReadEvent(google.protobuf.message.Message):
        ...
        def WhichOneof(
            self, oneof_group: typing.Literal["position", b"position"]
        ) -> typing.Literal["commit_position", "no_position"] | None: ...
    ...
    class SubscriptionConfirmation(google.protobuf.message.Message):
        ...
        def ClearField(
            self, field_name: typing.Literal["subscription_id", b"subscription_id"]
        ) -> None: ...
    ...
    class StreamNotFound(google.protobuf.message.Message):
        ...
        def HasField(
            self, field_name: typing.Literal["stream_identifier", b"stream_identifier"]
        ) -> builtins.bool: ...
        def ClearField(
            self, field_name: typing.Literal["stream_identifier", b"stream_identifier"]
        ) -> None: ...
    ...
    def __init__(
        ...
        *,
        ...
        last_all_stream_position: (
            esdbclient.protos.Grpc.shared_pb2.AllStreamPosition | None
        ) = ...,
    ...
    def WhichOneof(self, oneof_group: typing.Literal["content", b"content"]) -> (
        typing.Literal[
            "event",
            "confirmation",
            "checkpoint",
...
class AppendReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        ) -> typing.Literal["revision", "no_stream", "any", "stream_exists"] | None: ...
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["content", b"content"]
    ) -> typing.Literal["options", "proposed_message"] | None: ...
...
class AppendResp(google.protobuf.message.Message):
    ...
    class Success(google.protobuf.message.Message):
        ...
        ) -> typing.Literal["current_revision", "no_stream"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["position_option", b"position_option"]
        ) -> typing.Literal["position", "no_position"] | None: ...
    ...
    class WrongExpectedVersion(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            ...
            expected_stream_exists: (
                esdbclient.protos.Grpc.shared_pb2.Empty | None
            ) = ...,
        ...
        ) -> typing.Literal["current_revision", "current_no_stream"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
        ...
        ) -> typing.Literal["current_revision_20_6_0", "no_stream_20_6_0"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
    ...
    ) -> typing.Literal["success", "wrong_expected_version"] | None: ...
...
class BatchAppendReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["deadline_option", b"deadline_option"]
        ) -> typing.Literal["deadline_21_10_0", "deadline"] | None: ...
        @typing.overload
        def WhichOneof(
            self,
            oneof_group: typing.Literal[
            ...
            typing.Literal["stream_position", "no_stream", "any", "stream_exists"]
            | None
        ): ...
    ...
    def __init__(
        ...
        *,
        ...
        proposed_messages: (
            collections.abc.Iterable[global___BatchAppendReq.ProposedMessage] | None
        ) = ...,
        is_final: builtins.bool = ...,
    ) -> None: ...
    def HasField(
...
class BatchAppendResp(google.protobuf.message.Message):
    ...
    def WhichOneof(
        ...
        typing.Literal["stream_position", "no_stream", "any", "stream_exists"] | None
    ): ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing.Literal["result", b"result"]
    ) -> typing.Literal["error", "success"] | None: ...
