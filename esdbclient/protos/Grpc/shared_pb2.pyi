...
class StreamIdentifier(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["stream_name", b"stream_name"]
    ) -> None: ...
...
class WrongExpectedVersion(google.protobuf.message.Message):
    ...
    ) -> typing.Literal["current_stream_revision", "current_no_stream"] | None: ...
    @typing.overload
    def WhichOneof(
        self,
        oneof_group: typing.Literal[
...
class MaximumAppendSizeExceeded(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["maxAppendSize", b"maxAppendSize"]
    ) -> None: ...
