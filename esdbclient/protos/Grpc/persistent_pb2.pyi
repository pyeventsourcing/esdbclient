...
class ReadReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        ) -> typing.Literal["stream_identifier", "all"] | None: ...
    ...
    class Ack(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            id: builtins.bytes = ...,
            ids: (
                collections.abc.Iterable[esdbclient.protos.Grpc.shared_pb2.UUID] | None
            ) = ...,
        ) -> None: ...
        def ClearField(
            self, field_name: typing.Literal["id", b"id", "ids", b"ids"]
        ) -> None: ...
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["content", b"content"]
    ) -> typing.Literal["options", "ack", "nack"] | None: ...
...
class ReadResp(google.protobuf.message.Message):
    ...
    class ReadEvent(google.protobuf.message.Message):
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["count", b"count"]
        ) -> typing.Literal["retry_count", "no_retry_count"] | None: ...
        @typing.overload
        def WhichOneof(
    ...
    def __init__(
        ...
        *,
        ...
        subscription_confirmation: (
            global___ReadResp.SubscriptionConfirmation | None
        ) = ...,
    ) -> None: ...
    def HasField(
        self,
    ...
    def WhichOneof(
        self, oneof_group: typing.Literal["content", b"content"]
    ) -> typing.Literal["event", "subscription_confirmation"] | None: ...
...
class CreateReq(google.protobuf.message.Message):
    ...
    class AllOptions(google.protobuf.message.Message):
        ...
        class FilterOptions(google.protobuf.message.Message):
            ...
            def __init__(
                ...
                *,
                stream_identifier: (
                    global___CreateReq.AllOptions.FilterOptions.Expression | None
                ) = ...,
                event_type: (
                    global___CreateReq.AllOptions.FilterOptions.Expression | None
                ) = ...,
    ...
    class Settings(google.protobuf.message.Message):
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["checkpoint_after", b"checkpoint_after"]
        ) -> typing.Literal["checkpoint_after_ticks", "checkpoint_after_ms"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["message_timeout", b"message_timeout"]
        ) -> typing.Literal["message_timeout_ticks", "message_timeout_ms"] | None: ...
...
class GetInfoResp(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["subscription_info", b"subscription_info"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["subscription_info", b"subscription_info"]
    ) -> None: ...
...
class SubscriptionInfo(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            ...
            observed_measurements: (
                collections.abc.Iterable[global___SubscriptionInfo.Measurement] | None
            ) = ...,
            available_slots: builtins.int = ...,
            in_flight_messages: builtins.int = ...,
            connection_name: builtins.str = ...,
    ...
    def __init__(
        ...
        *,
        ...
        status: builtins.str = ...,
        connections: (
            collections.abc.Iterable[global___SubscriptionInfo.ConnectionInfo] | None
        ) = ...,
        average_per_second: builtins.int = ...,
        total_items: builtins.int = ...,
        count_since_last_measurement: builtins.int = ...,
...
class ReplayParkedReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["stop_at_option", b"stop_at_option"]
        ) -> typing.Literal["stop_at", "no_limit"] | None: ...
        @typing.overload
        def WhichOneof(
            self, oneof_group: typing.Literal["stream_option", b"stream_option"]
        ) -> typing.Literal["stream_identifier", "all"] | None: ...
...
class ListReq(google.protobuf.message.Message):
    ...
    class Options(google.protobuf.message.Message):
        ...
        def WhichOneof(
            self, oneof_group: typing.Literal["list_option", b"list_option"]
        ) -> typing.Literal["list_all_subscriptions", "list_for_stream"] | None: ...
