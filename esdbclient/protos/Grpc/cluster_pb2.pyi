...
class GossipRequest(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing.Literal["info", b"info", "server", b"server"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing.Literal["info", b"info", "server", b"server"]
    ) -> None: ...
...
class EndPoint(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["address", b"address", "port", b"port"]
    ) -> None: ...
...
class ReplicatedTo(google.protobuf.message.Message):
    ...
    def ClearField(
        self, field_name: typing.Literal["log_position", b"log_position"]
    ) -> None: ...
